...
const PIEZAS: { slug: string; tema: string; propiedad: PropiedadKey; fuente: 'diseno' | 'foto'; foto?: string }[] = [
  ...
  { slug: 'foto-plusvalia',    tema: 'Plusvalía comprobada — Parque Chapultepec ha subido de valor año con año, comprar aquí es asegurar patrimonio, no solo un lugar para vivir', propiedad: 'departamento', fuente: 'foto', foto: 'depto-real-sala-cocina.jpg' },
...
const PROPIEDADES: Record<PropiedadKey, {
  ...
  departamento: {
    ...
    specs: 'Departamento $3,000,000 MXN, 100m² de construcción, 2 recámaras, 2 baños, balcón privado, 1 cajón de estacionamiento, Bajada de Chapultepec 18-A, Cuernavaca',
...
const VIDEOS: { archivo: string; gancho: string }[] = [
  ...
  { archivo: 'video2-departamento.mp4', gancho: 'El departamento de $3,000,000 en Parque Chapultepec. 100 m², dos recámaras y balcón, a 50 m del parque.' },
